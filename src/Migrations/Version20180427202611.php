 ...
 */
class Version20180427202611 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE author (id INT NOT NULL, first VARCHAR(100) NOT NULL, middle VARCHAR(100) DEFAULT NULL, last VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
